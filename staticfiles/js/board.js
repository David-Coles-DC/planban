        ...
        fetch('/projects/update-list-order/', {
            ...
            .then((data) => {
                if (data.success) {
                    ...
                    showCToast("info", "list order failed to update successfully")
                }
            });
    }
        ...
        fetch('/projects/update-item-order/', {
            ...
            .then((data) => {
                if (data.success) {
                    ...
                    showCToast("info", "item order failed to update successfully")
                }
            });
    }
            ...
            fetch(`/projects/update-list-title/${listId}/`, {
                ...
                .then((data) => {
                    if (data.success) {
                        ...
                        showCToast("info", "Failed to update list title");
                    }
                })
                .catch((error) => {
                    showCToast("info", "Failed to update list title");
    ...
    addListForm.addEventListener('submit', function(event) {
        ...
        .then(data => {
            if (data.success) {
                ...
                showCToast("info", "Failed to add list");
            }
        })
    ...
    if (confirmation) {
        ...
        .then(response => {
            if (response.ok) {
                ...
                showCToast("info", "Failed to delete the list");
            }
        })
        .catch(error => {
            showCToast("info", "An error occurred while deleting the list!");
        });
    }
}
